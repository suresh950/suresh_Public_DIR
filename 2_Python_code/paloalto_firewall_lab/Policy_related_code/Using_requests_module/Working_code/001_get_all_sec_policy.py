"""
TO get all the security policy available in firewall in raw formate ----->without commit
"""
import urllib3
import ssl
import requests
...
api_url = f"https://{firewall_ip}/restapi/v10.1/Policies/SecurityRules?location=vsys&vsys=vsys1"
